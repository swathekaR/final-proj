    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
         <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="listorder.php" class="nav-link"  style="background-color: #e83e8c; color: white;">
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Orders Data table</h3> 
                <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#add" style="margin-left:80%"><i class="fa fa-plus">Add</i>
                </button>
                        ...
                        <div class="modal-dialog modal-md">
                          ...
                          <div class="modal-content">
                            <div class="modal-header">
                              <h4 class="modal-title">Add List Order</h4>
                            ...
                            <div class="col-6">
                              ...
                              <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" row="5" id="" name="" placeholder="Enter Customer Name ..">
                                </div>
                              </div>
                              <div class="col-6">
                                <div class="form-group">
                              ...
                              <div class="form-group">
                                  <label>Price</label>
                                  <input type="text" class="form-control" row="5" id="" name="" placeholder="00.00">
                                </div>
                              </div>
                             <div class="col-6">
                                <div class="form-group">
                              ...
                              <div class="form-group">
                                  <label>Remarks</label>
                                  <textarea class="form-control" row="4" id="" name="" placeholder="Enter .."></textarea>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>Data</td>
                       <td>Data</td>
                      <td>20</td>
                      <td><i style="color: blue">232</i></td>
                      <td>Data</td>
                      <td>Data</td>
                       <td>
            ...
            <div class="modal fade" id="update">
                        <div class="modal-dialog modal-md">
                          ...
                          <div class="modal-content">
                            <div class="modal-header">
                              <h4 class="modal-title">Update List Order</h4>
                              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                              </button>
                            </div>
