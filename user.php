          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                ...
                <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#add" style="margin-left:72%"><i class="fa fa-plus">Add</i>
                </button>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>******</td>
                      <td>Data</td>
                      <td><i style="color: blue"><u>Data.@sss</u></i></td>
                      <td>Data</td>
                      <th><span class="right badge badge-danger">Data</span></th>
                       <td>
