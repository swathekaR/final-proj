                          ...
                          <div class="modal-content">
                            ...
                            <div class="col-6">
                              <div class="form-group">
                                  <label>Code</label>
                                  <input type="text" class="form-control" row="5" id="" name="" placeholder="Enter Product Code..">
                                </div>
                              </div>
                               <div class="col-6">
                              <div class="form-group">
                                  <label>Name</label>
                                  <input type="text" class="form-control" row="5" id="" name="" placeholder="Enter Product Name..">
                                </div>
                              </div>
                               <div class="col-6">
                              <div class="form-group">
                                  <label>Detail</label>
                                  <input type="text" class="form-control" row="5" id="" name="" placeholder="Enter Product Detail..">
                                </div>
                              </div>
                               <div class="col-6">
                              <div class="form-group">
                                  <label>Category</label>
                                  <input type="text" class="form-control" row="5" id="" name="" placeholder="Enter Product Category..">
                                </div>
                              </div>
                               <div class="col-3">
                              <div class="form-group">
                              ...
                              <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" row="5" id="" name="" placeholder="P 00.00">
                                </div>
                              </div>
                               <div class="col-3">
                              <div class="form-group">
                              ...
                              <div class="form-group">
                                  <label>Disc.</label>
                                  <input type="text" class="form-control" row="5" id="" name=""  placeholder="0%">
                                </div>
                              </div>
                                <div class="col-6">
                                <div class="form-group">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>Data</td>
                      <td>32</td>
                      <td><b style="color: blue">75.00</b></td>
                      <td><i style="color:blue">70.00</i></td>
                      <td><i style="color:red">5%</i></td>
                      <td>Data</td>
